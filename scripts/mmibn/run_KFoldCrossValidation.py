    ...
    for num_repeat in range(num_repeat_start, num_repeats+1):
        ...
        for eval_folder in ["training", "closed-test", "open", "open-closed"]:
            ...
            with open(results_file, 'wb') as outcsv:
                ...
                writer.writerow(["Num_repeat", "Fold", "Time_type", "Sample_size", "Learning_method", "Norm_method", "I_FAR", "F_FAR", "I_DIR", "F_DIR", "I_Loss", "F_Loss",  "Num_recognitions", "Num_registered", "Recognition_time"])
